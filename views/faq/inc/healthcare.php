<section>
    <div class="container-fluid" style="padding:0px;">
        <div>
            <img src="/assets/images/faq/faq_healthcare_secotor.jpg" width="100%" height="100%" alt="" />
        </div>
    </div>
</section>
        ...
        <div class="single-sidebar-widget">
          <div class="special-links"  <?php if($_SESSION['lang']==="ar"){?>  style="text-align: right" <?php } ?>>
            <ul>
              ...
              <li><a class="active" href="#"><?php echo $output['healthcare_sector'] ?></a></li>
            </ul>
          </div>
        </div>
      </div>
      <div class="col-md-9 col-sm-7">
		<h3 <?php if($_SESSION['lang']==="ar"){?>  style="text-align: right" <?php } ?>><?php echo $output['healthcare_sector'] ?></h3>
        <div class="text-box">
